...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vuedraggable__ = __webpack_require__(39);
...
var app = new Vue({
    ...
    methods: {
        addSubMenu: function addSubMenu() {
            var newSubMenu = Object.assign({}, this.sub_menu);
            this.menu.sub_menus.push(newSubMenu);
        },
        removeSubMenu: function removeSubMenu(i) {
