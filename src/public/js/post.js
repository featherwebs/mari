...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2), __webpack_require__(30).setImmediate))
        ...
        showPreview: function showPreview(index, event) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    p.post.images[index]['thumbnail'] = e.target.result;
                };

                reader.readAsDataURL(input.files[0]);
            }
        },
        removeImage: function removeImage(k) {
            var removedImage = this.post.images[k];
            if (removedImage && removedImage.id) this.deleted_image_ids.push(removedImage.id);
            this.post.images.splice(k, 1);
        },
        removeCustomField: function removeCustomField(k) {
            this.post.custom.splice(k, 1);
        },
