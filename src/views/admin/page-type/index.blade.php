        ...
        @slot('breadcrumb')
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Page Type</li>
                </ol>
            </nav>
        @endslot
        <div>
            ...
            $('#page-datatable').DataTable({
                ...
                columns:[
                    ...
                    {data: 'slug',name: 'slug', searchable:false, orderable:false, render: function(data,meta,row){
                        var actions = '<form method="POST" action="/admin/page-type/'+ data +'">';
                        actions += '<input type="hidden" name="_method" value="DELETE">';
                        actions += '<input type="hidden" name="_token" value="'+$('[name=csrf-token]').attr('content')+'">';
                    @permission('update-post-type')
                        actions += '<a href="/admin/page-type/' + data +'/edit" class="mdl-button mdl-js-button"><i class="material-icons">edit</i></a>';
                    @endpermission
