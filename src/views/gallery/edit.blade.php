        ...
        <form action="{{ route('admin.media.show','all') }}">
            ...
            @forelse($medias as $media)
                <div class="col-md-2 gallery-image-checkbox">
                    <input type="checkbox" name="image[]" id="media-{{ $media->id }}" value="{{ $media->id }}">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('admin.gallery.edit', $gallery) }}" class="btn btn-default">Done</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.mydropzone').dropzone({
                paramName: "file",
                maxFilesize: 20,
                url: "{{ route('admin.gallery.store_image', $gallery) }}",
